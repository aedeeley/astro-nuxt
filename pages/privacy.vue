        ...
        <div class="container pb-5">
            <div class="row mt-5 mb-5 pt-5 pb-5" data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">
                <div class="col big paragraph">
                    <h2 class="mb-5">Astro Privacy Policy</h2>

                    <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from https://www.astroweb.io (the “Site”).</p>
                    ...
                    <p>- “Cookies” are data files that are placed on your device or computer and often include an anonymous unique identifier. For more information about cookies, and how to disable cookies, visit https://www.allaboutcookies.org.<br />
            ...
            - "Web beacons,” “tags,” and “pixels” are electronic files used to record information about how you browse the Site.</p>
                        ...
                        <p><strong>Additionally, we use this Order Information to:</strong><br />
            ...
            When in line with the preferences you have shared with us, provide you with information or advertising relating to our products or services.</p>
                            ...
                            <p>You can opt out of targeted advertising by emailing <a href="mailto:alex@bastroweb.io">alex@astroweb.io</a></p>
                        ...
                        <p>Please note that we do not alter our Site’s data collection and use practices when we see a Do Not Track signal from your browser.
                            ...
                            <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at alex@astroweb.io or by mail using the details provided below:</p>

                            <p>1269 Logan St, Apt B10, Denver, CO, 80203, United States</p>
